...
start cmd /k "cd service-registry && python app.py"
timeout /t 3
...
start cmd /k "cd student-service && python app.py"
timeout /t 3

echo.
echo Starting Course Service (Port 5002)...
start cmd /k "cd course-service && python app.py"
timeout /t 3

echo.
echo Starting Attendance Service (Port 5005)...
start cmd /k "cd attendance-service && python app.py"
timeout /t 3
